...
**Status: Milestone 1 API and owning-memory candidate; build validation is blocked.** The package contains a common API surface, validated greyscale16 storage and synthetic contract tests. Codec algorithms, working compression/decompression, transcoding and CLI are not implemented yet. The intended first stable library version remains **2.0.0**; no release is tagged.
