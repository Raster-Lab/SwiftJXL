...
Contract **0.7.0**. The executable foundation provides help, version and actual capability reporting. Codec operations remain unavailable and return exit 4 before reading input or creating output.
